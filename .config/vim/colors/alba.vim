...
hi! Normal          ctermfg=White        ctermbg=Black    cterm=NONE    guifg=#DDDDDD    guibg=#080808    gui=NONE
hi! Highlight       ctermfg=White        ctermbg=Black    cterm=NONE    guifg=#FFFFFF    guibg=#080808    gui=NONE
hi! FadedLight      ctermfg=White        ctermbg=Black    cterm=NONE    guifg=#8C8C8C    guibg=#080808    gui=NONE
hi! FadedStrong     ctermfg=White        ctermbg=Black    cterm=NONE    guifg=#404040    guibg=#080808    gui=NONE
hi! Empty           ctermfg=White        ctermbg=Black    cterm=NONE    guifg=#080808    guibg=#080808    gui=NONE
hi! ErrorMsg        ctermfg=DarkGray     ctermbg=Black    cterm=NONE    guifg=#fd1813    guibg=#080808    gui=NONE
hi! WarningMsg      ctermfg=210          ctermbg=Black    cterm=NONE    guifg=#d99962    guibg=#080808    gui=NONE
...
" -------------------------------
"
hi! Directory       ctermfg=White        ctermbg=Black    cterm=NONE    guifg=#DDDDDD    guibg=#080808    gui=NONE
hi! link netrwPlain      FadedLight

hi! Search          ctermfg=White        ctermbg=210      cterm=NONE    guifg=#080808    guibg=#D99962    gui=NONE
hi! IncSearch       ctermfg=White        ctermbg=210      cterm=NONE    guifg=#080808    guibg=#D99962    gui=NONE
if &term =~ 'linux'
...
" Diff
" --------------------------------
hi! DiffAdd         ctermfg=White    ctermbg=Black    cterm=NONE    guifg=#F2F2F2    guibg=#080808    gui=NONE
hi! DiffChange      ctermfg=White    ctermbg=Black    cterm=NONE    guifg=#F2F2F2    guibg=#080808    gui=NONE
hi! DiffDelete      ctermfg=White    ctermbg=Black    cterm=NONE    guifg=#F2F2F2    guibg=#080808    gui=NONE
hi! DiffText        ctermfg=White    ctermbg=Black    cterm=NONE    guifg=#F2F2F2    guibg=#080808    gui=NONE
